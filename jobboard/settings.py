...
SECRET_KEY = 'django-insecure-&39%b*c%cb@n2z1-j39^-%l^3s8ute@8wdmu&5!-80^969$ceq'
...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / "templates"],  # your global templates dir (optional)
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Optional for development: tells Django where to look for static files
STATICFILES_DIRS = [
